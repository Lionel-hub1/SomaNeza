...
const games = [
    {
        type: 'soundmatch' as GameType,
        title: 'Umva Uhitemo',
        subtitle: 'Sound Match',
        emoji: '🔊',
        description: 'Umva ijwi uhitemo igisubizo!',
        gradient: 'from-violet-500 to-purple-600',
    },
    {
        type: 'train' as GameType,
        title: 'Igariyamoshi',
        subtitle: 'Syllable Train',
        emoji: '🚂',
        description: 'Kora igariyamoshi y\'imyandikire!',
        gradient: 'from-emerald-500 to-green-600',
    },
    {
        type: 'wordbuilder' as GameType,
        title: 'Kurema Amagambo',
        subtitle: 'Word Builder',
        emoji: '🧩',
        description: 'Huza ibice ukore amagambo!',
        gradient: 'from-amber-500 to-orange-600',
    },
    {
        type: 'stars' as GameType,
        title: 'Fata Inyenyeri',
        subtitle: 'Catch Stars',
        emoji: '⭐',
        description: 'Fata inyenyeri zikwiye!',
